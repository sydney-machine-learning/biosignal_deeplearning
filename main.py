...
for m in range(runs):
    ...
    ch2 = EarlyStopping(monitor="val_loss",patience=100,verbose=0,mode="min")
    history6 = model6.fit(Xtrain, Ytrain, validation_data = (Xtest, Ytest), epochs=2000, batch_size=100000, callbacks=[ch1,ch2], verbose=0)
    ...
    ch2 = EarlyStopping(monitor="val_loss",patience=100,verbose=0,mode="min")
    history7 = model7.fit(Xtrain, Ytrain, validation_data = (Xtest, Ytest), epochs=2000, batch_size=100000, callbacks=[ch1,ch2], verbose=0)
